...
<template>
  <AppLayout title="Attendance">
    <div class="flex flex-col gap-6 pb-[60px]">
      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        >
          <div class="flex flex-1 flex-col gap-4">
            <div class="flex items-center gap-2">
              ...
              <div
                class="text-xs leading-4 font-medium tracking-[0.6px] text-[#424754] uppercase"
              >
                STATUS SEKARANG
              </div>
            </div>
        ...
        >
          ...
          <div class="relative flex flex-col">
            <div
              class="text-xs leading-4 font-medium tracking-[0.24px] text-[#adc6ff] opacity-90"
            >
              Real-time Clock
            </div>
            <div
      ...
      >
        <div
          class="flex items-center justify-between border-b border-[#c2c6d6] px-6 pt-6 pb-[25px]"
        >
          <div class="flex flex-col">
            <h4
              class="font-['Plus_Jakarta_Sans'] text-lg leading-[26px] font-semibold text-[#191b23]"
            ...
            <div
              class="text-xs leading-4 font-medium tracking-[0.24px] text-[#424754]"
            >
              {{ currentMonthLabel }}
            </div>
          </div>
